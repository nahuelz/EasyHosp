...
public class AceptarSolicitudController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		servicio.aceptarSolicitud(idSolicitud);
		request.setAttribute("msj", "Solicitud Aceptada");
		request.setAttribute("tipo", 1);
		request.getRequestDispatcher("MisSolicitudesController?tipo=2").forward(request,response);
